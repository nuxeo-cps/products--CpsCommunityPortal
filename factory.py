...
class SiteConfigurator(CPSSiteMetaConfigurator):
     """CPS community portal configurator"""

     meta_profiles = {
         'CPS_COMMUNITY': {'title' : 'Common set of components',
                             'extensions': ('CPSRSS:default',
                                            'CPSSubscriptions:default',
                                            'CPSDefault:folder_advanced_display',
                                            'CpsCommunityPortal:default',
                                            ),
                          'optional' : False,
     ...
     form_heading = "Add CPS community portal"
     post_action = 'addConfiguredCpsCommunityPortal'
...
def addConfiguredCpsCommunityPortalForm(dispatcher):
    """Form to add a CPS Site from ZMI.
    """
    return _cpsconfigurator.addConfiguredSiteForm(dispatcher)

def addConfiguredCpsCommunityPortal(dispatcher, REQUEST=None, **kw):
